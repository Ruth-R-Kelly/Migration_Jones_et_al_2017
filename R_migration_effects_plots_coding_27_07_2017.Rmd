...
#pdf("Fig4_differences_migrant_nonmigrant.pdf", height = 5, width = 3.5)
Fig4 <- ggplot(x1, aes(x = dist2park, y = fit, group = eduPA, linetype = education,  colour = PA, fill = PA)) +
scale_colour_brewer(palette = "Dark2") +
scale_fill_brewer(palette = "Dark2") +
geom_ribbon(aes(ymin = lwr, ymax = upr, linetype = NA), alpha = 0.20) +
geom_line(size = 1.5) +
  ylim(0,1) + 
...
plot_dist2 <- ggplot(x2, aes(x = dist2park, y = fit, group = eduPAmig, colour = eduPA, fill = eduPA, linetype = MigrantF)) + 
   ylim(0,1.05) + 
scale_colour_brewer(palette = "Dark2") +
 scale_fill_brewer(palette = "Dark2", labels = c("Established", "New")) +
...
# ## output as PDF
# pdf("Supp_Fig4_Deforestation_agri_areas2.pdf", width = 7.4, height = 4.2)
